// Credit to https://github.com/tobika/spotify-auth-PKCE-example/blob/main/public/main.js
...
(function () {
    ...
    function getUserPlaylists() {
        fetch('https://api.spotify.com/v1/me/playlists', {
          ...
          .then((data) => {
            ...
            playlistList.innerHTML = ''; // Clear previous playlist data
    ...
    document
      .getElementById('fetch-playlists-button')
      .addEventListener('click', getUserPlaylists, false);
